...
<Image
  src="/images/pics/ReadStep4.png"
  alt="Sediment Flux at the Catchment Scale"
  float="right"
...
<Grid container spacing={3} sx={{mt: 2}} padding={2}>
      <StoryCard 
        ...
        image={"/images/slides/Module14.png"}
        description="Sediment flux at the catchment scale: source-to-sink relationships"
        to="https://s3-us-west-2.amazonaws.com/etalweb.joewheaton.org/Courses/fluvial/2021/WATS5150_Module_14_SedFlux.pdf" /> 
</Grid>
...
<Image
  src="/images/pics/MorphologicalMethod.png"
  alt="Morphological Method"
  float="right"
  to="http://gcd.riverscapes.xyz/Tutorials/GeomorphicInterpretation/morphological-approach.html"
