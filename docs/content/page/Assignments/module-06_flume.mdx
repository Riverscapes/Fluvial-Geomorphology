...
<Button to="../Course_Topics/module-06" title="See Corresponding Learning Module" fullWidth color="secondary" iconName="AutoStories" />
...
<Youtube embedId="S_iBiw0bA3g" caption="EM-River EM2 Stream Table" />
...
<Button to="https://photos.app.goo.gl/bBndwsfLFUVFdUb66" title="Flume Album" iconName="PhotoAlbum"  />
...
### 2021
In our  [2021 class](../syllabus/2021_Spring.html#2021-cohort) some of the students really went above and beyond.  Some of the most effective examples are shown below:
...
<Grid container spacing={3} sx={{mt: 2}} padding={2}>
    <StoryCard 
        ...
        image={"https://static.wixstatic.com/media/74edfc_c966ebcd4499464b94413617366c3369~mv2.png/v1/crop/x_0,y_78,w_1716,h_861/fill/w_1716,h_861,al_c,q_90/Slope_PNG.webp"}
        description="A simple annotated sketch goes a long way..."
        to="https://jensammon5.wixsite.com/jens/flume-demo" />
    <StoryCard 
        title="Grain Sorting"
        image={"https://fluvialtalk.weebly.com/uploads/1/3/5/8/135836902/sorting_orig.png"}
        description="Sorted.. Megh!"
        to="https://fluvialtalk.weebly.com/module-6---flume-assignment.html" />
    <StoryCard
      title="Discharge"
      image={"https://static.wixstatic.com/media/74edfc_403643522e6f458299cfad9cd9230962~mv2.png/v1/fill/w_590,h_566,al_c,q_85,usm_0.66_1.00_0.01/Discharge_PNG.webp"}
    ...
    <StoryCard
      ...
      image={"https://waterinaction.files.wordpress.com/2021/02/img_20210208_162156a.jpg"}
      description="One of the clearsest examples of the difference in grain size is in this wonderful example from Manisha."
      to="https://waterinaction.wordpress.com/fluvial-dynamics/"
      />

  </Grid>
#### Videos

<Youtube embedId="e4S-R62fvKY" caption="Manisha's Video Annotation of Processes. She did a great job of using text editing in her video to highlight how the flume works and specific processes." />

<Youtube embedId="ahvhg2HeVpk" caption="Lauren'did one of the most impressive jobs of taking one of the videos and annotating what's going on throughout." />

<Youtube embedId="RFwnOwOzDRs" caption="Daniel did a great job of explaining individual mechanisms and narrating what was going on." />
