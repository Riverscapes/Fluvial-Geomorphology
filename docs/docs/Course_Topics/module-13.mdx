  ...
  cards={[
    {
      ...
      imageUrl: "/images/slides/Module13.png",
      toolUrl: "https://s3-us-west-2.amazonaws.com/etalweb.joewheaton.org/Courses/fluvial/2021/WATS5150_Module_13_HumanImpacts.pdf"
    }
  ]}
/>
...
This module focuses on: [CHAPTER THIRTEEN: Human impacts on river systems](https://ebookcentral-proquest-com.dist.lib.usu.edu/lib/usu/reader.action?docID=1032536&ppg=285)
...
- [WATS 5620-5624 - Low-Tech Process-Based Restoration of Riverscapes](http://lowtechpbr.restoration.usu.edu/workshops/uni)
