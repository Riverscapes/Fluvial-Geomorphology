...
title: Syllabai
description: Syllabus for WATS/CEWA 5155/6155 - Fluvial Geomorphology - Reading Riverscapes
sidebar_position: 4
...
Introduction to fluvial geomorphology through the reading of landscapes and riverscapes. Students learn an appreciation of riverscape diversity and how fluvial processes shape landscape form and character. Self-led field trips (in riverscapes of student's choosing) are required. 

| **Semester(s) Traditionally Offered** | Spring |
|--------------|------|
| **Credits**: |3.000 Credit hours Matriculated (4.5 CEUs) |
| **Levels**: |Graduate, Undergraduate|
| **Schedule Types**: |Online Asynchronous |
| **Cross-Listed As**: |Spring 2026: WATS 6900 & CEWA 6900; Proposed Spring 2027 WATS 6155 CEWA 6155|
| **Pre-requisites**| None |


## Individaul Schedule & Syllabai

This course is typically taught every Spring online (pending adequate demand). 
...
#### Past Versions
This class was previously delivered by Professsor Wheaton as hybrid (in person and online synchronous) as WATS/GEO/CEWA 5150/6150. That class is still be offerred but switching to in person only delivery and being taught in Fall 2026 by Professor [Julianne Scarmado](https://qanr.usu.edu/directory/scamardo-julianne). 
...
<ToolsWrapper
  ...
  cards={[
	{
	  title: 'Spring 2021',
	  toolUrl: '/syllabus/2021Spring',
	  description: 'Schedule & Syllabus'
	},
	{
	  title: 'Spring 2022',
	  toolUrl: '/syllabus/2022Spring',
	  description: 'Schedule & Syllabus'
	},
	{
	  title: 'Spring 2024',
	  toolUrl: '/syllabus/2024Spring',
	  description: 'Schedule & Syllabus'
	},
	{
	  title: 'Spring 2025',
...
Fees were removed from this course. 

- **USU Students** - Regular [tuition](https://www.usu.edu/financial-support/coa) is charged on a per credit basis for USU students.  
- **Non-USU Students** - $1049.95 for Spring 2026 (see at [CEU Checkout](https://cpe.usu.edu/search/publicCourseSearchDetails.do;jsessionid=2A8B44C22A2695F1B8B285E2342D5ABB?method=load&courseId=1015262#courseSectionDetails_1544055))
...
This is an introductory course in fluvial geomorphology. Geomorphology is the study of landforms and processes that shape them. Fluvial geomorphology is a sub-discipline that focuses on *fluvial* processes (i.e., shaped by water) and landforms. We call the part of the landscape in which fluvial processes dominate, riverscapes. Students will learn many of the tools and models of the [Riverscapes Consortium](https://riverscapes.net) and become proficient in QGIS (no previous GIS background necessary, but it will help.
...
| **LO 5**. | Understand how hydrologic processes, give rise to hydraulic processes, which in local riverscapes determine the rates, magnitudes  and  occurrence of fluvial geomorphic processes. |
